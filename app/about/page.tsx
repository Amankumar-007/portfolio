...
export default function AboutPage() {
  ...
  return (
    <>
      <Head>
        <title>About | Aman Kumar - Full Stack Developer & SaaS Expert</title>
        <meta name="description" content="Learn about Aman Kumar, expert Full Stack developer specializing in high-performance web applications and SaaS solutions. Discover skills in React, Next.js, Node.js, and modern tech stacks." />
        <meta name="keywords" content="Aman Kumar about, Full Stack developer, SaaS developer, React developer, Node.js developer, Next.js expert, SaaS solutions, software engineer portfolio" />
        <meta property="og:title" content="About | Aman Kumar - Full Stack Developer" />
        <meta property="og:description" content="Learn about Aman Kumar, expert Full Stack developer specializing in modern web applications and SaaS solutions." />
        ...
        <meta name="twitter:title" content="About | Aman Kumar - Full Stack Developer" />
        <meta name="twitter:description" content="Learn about Aman Kumar, expert Full Stack developer specializing in modern web applications and SaaS solutions." />
            ...
            <div className="grid gap-16 lg:grid-cols-2 mb-25">
              <div data-scroll data-scroll-speed="1">
                ...
                <p className="text-xl text-slate-500 mb-8 font-medium max-w-md">
                  Full-stack developer building robust SaaS applications and web platforms with a focus on performance and raw aesthetics.
                </p>
