    ...
    <ErrorBoundary>
      <>
        <Head>
          ...
          <meta property="og:description" content="Explore Aman Kumar's best Full Stack and SaaS projects. Modern web applications built with Next.js, React, Node.js, and MongoDB." />
          ...
          <meta name="twitter:title" content="Projects | Best Full Stack Projects - Aman Kumar" />
          <meta name="twitter:description" content="Explore Aman Kumar's best Full Stack and SaaS projects. Modern web applications built with Next.js, React, Node.js, and MongoDB." />
          ...
          <script
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify({
                ...
                "description": "Explore Aman Kumar's best Full Stack and SaaS projects. Modern web applications built with Next.js, React, Node.js, MongoDB, and modern architectures.",
