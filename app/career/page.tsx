...
export default function LearningJourney() {
  ...
  return (
    <>
      <Head>
        <title>Career Journey | Aman Kumar - Full Stack Developer Path</title>
        <meta name="description" content="Follow Aman Kumar's career journey as a Full Stack and SaaS developer. From beginner to expert full-stack developer. Learn about the path to modern web development." />
        <meta name="keywords" content="Aman Kumar career, developer journey, Full Stack path, SaaS development, full stack developer career, React developer growth, web development career, programming journey" />
        <meta property="og:title" content="Career Journey | Aman Kumar - Full Stack Developer Path" />
        <meta property="og:description" content="Follow Aman Kumar's career journey as a Full Stack and SaaS developer. From beginner to expert full-stack developer." />
        ...
        <meta name="twitter:title" content="Career Journey | Aman Kumar - Full Stack Developer Path" />
        <meta name="twitter:description" content="Follow Aman Kumar's career journey as a Full Stack and SaaS developer." />
